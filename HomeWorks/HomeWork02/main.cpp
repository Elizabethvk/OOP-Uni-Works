...
//#include "../hpp/Interaction.hpp"
#include "Interaction.h"

// TODO: Make things in functions, when I can, const, and functions smth smth () const
// TODO: Fix all member functions' positions
// TODO: Fix input if !cin
...
void exitProgram(Interaction& userInteraction, bool& areWeExiting) {
    ...
    case 2:
        ...
        //cout << "All the data was saved!" << endl;
        areWeExiting = true;
        return;
        // break;
    case 3:
...
int main(int argc, char* argv[]) {
	...
	if (argc > 1) {
		...
		//     while(!startFile.eof()) {
		//         getline(startFile, argument);
		//         userInteraction.userPreference(argument);
		//     } */
